...
// In Schritt 4 wird folgendes eingeführt:
// a) Abfragemethode 1 für Pointer Queue
// b) Erweiterung des Hauptprogramms, welches die Abfragefunktion 1 nutzt
...
int main(void){
    ...
    greetings.receive_method1(out_string);
    std::cout << std::endl << "-------Methode 1--------" << std::endl << *out_string << std::endl;
    delete out_string;
    out_string = nullptr;
    // zu diskutieren
    // a) Methode, warum stürzt die ab?
    // b) delete
